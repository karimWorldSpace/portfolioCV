...
const EducationInfo: React.FC<EducationInfoProps> = ({imageNumber}) => {
    ...
    switch (imageNumber) {
        case 1:
            ...
            schoolAddr = "Drancy, Paris, France"
            school = "Lycee Paul Le Rolland";
            bgColor = "radial-gradient(50% 50% at 50% 50%, rgba(209, 216, 255, 0.20) 0%, rgba(224, 229, 255, 0.20) 100%)";
            schoolDesc = "Earned my High School Diploma in Computer Science, showing strong base in IT (Information Technology)."
            break;
        case 2:
            textColor = "#FF5D5D";
            schoolGrade = "Bachelor of Science in Computer Science"
            schoolAddr = "Villetaneuse, Paris, France"
            school = "Universite Sorbonne XIII";
            bgColor = "radial-gradient(50% 50% at 50% 50%, rgba(255, 209, 209, 0.20) 0%, rgba(255, 224, 224, 0.20) 100%)";
            schoolDesc = "Graduated with a Bachelor in Computer Science from Univ Paris Sorbonne XIII, mastering software and algorithms."
            break;
        case 3:
            textColor = "#0F1727";
